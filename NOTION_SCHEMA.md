...
| Importance | Number | 1~5 중요도 (종합) |
| Exam Count (SAT) | Number | 수능 본시험 출제 횟수 |
| Exam Count (Mock) | Number | 평가원 모의평가 출제 횟수 |
| EBS Count | Number | EBS 수능특강/완성 수록 횟수 |
| Latest Year | Rich text | 가장 최근 출제 학년도 |
